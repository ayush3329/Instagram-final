...
import { z } from 'zod'
import { groupParticipantDetail} from '@ayush/ui/dest/ContextTypes'
...
export async function getGroupInfo(req: Request, res: Response<GroupType>) {
  ...
  try {
    ...
    const mainAdmin: string = findGroup.mainAdmin
    type GenzMix = groupParticipantDetail
    var participantDetails: GenzMix  [] = [];
