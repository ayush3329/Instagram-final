...
exports.UpdateSequence = exports.createOrdinarChat = exports.getGroupInfo = exports.RecentChatsUser = exports.ordinaryChat = exports.SearchUser = exports.jwtt = exports.Signup = exports.Login = void 0;
...
function getGroupInfo(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const mainAdmin = findGroup.mainAdmin;
            ...
            for (let i = 0; i < findGroup.users.length; i++) {
                ...
                participantDetails.push({
                    ...
                    admin: findGroup.admins.includes(find.fullname) ? (true) : (false),
                    mainAdmin: mainAdmin
                });
            }
            const wrapper = {
